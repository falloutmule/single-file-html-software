...
export const DB_NAME = 'the-imaginarium-library-v1';
export const PREFERENCE_KEY = 'the-imaginarium.preferences@1';
...
export class ImaginariumStorage extends EventTarget {
  constructor() {
    super();
    this.db = null;
