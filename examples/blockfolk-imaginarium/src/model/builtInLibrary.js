...
export function validateBuiltInLibrary() {
  ...
  if (BUILT_IN_BACKGROUNDS.length !== 1 || BUILT_IN_STICKERS.length !== 30 || BUILT_IN_ASSETS.length !== 31 || !BUILT_IN_BACKGROUNDS[0].production || !BUILT_IN_BACKGROUNDS[0].classic || BUILT_IN_BACKGROUNDS[0].debug) throw new Error('BlockFolk must contain only Classic Valley and exactly 30 accepted stickers.');
