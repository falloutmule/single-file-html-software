...
- Port capacity, plane, reciprocal type, opposing normal, scale, duplicate endpoint/pair, same-component, and finite-transform invariants are enforced centrally.
...
- Snap is opt-in and explicit-metadata-only; assemblies persist, are safely traversed as components, and support group edit, copy, delete, z-order, Undo/Redo, save/reload, and member-only Unsnap.
- Selection actions fit in the phone toolbar, with manual size/turn transforms in More/Edit.
